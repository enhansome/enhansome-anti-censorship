...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,527 | 🐛 106 | 📅 2026-09-02 list.
...
* [i2p](https://github.com/i2p/i2p.i2p) ⭐ 2,699 | 🐛 16 | 🌐 Java | 📅 2026-09-11 - I2P is an anonymizing network, offering a simple layer that identity-sensitive applications can use to securely communicate. All data is wrapped with several layers of encryption, and the network is both distributed and dynamic, with no trusted parties.
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,754 | 🐛 98 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW
* [gost](https://github.com/ginuerzh/gost) ⭐ 18,221 | 🐛 291 | 🌐 Go | 📅 2026-08-30 - GO Simple Tunnel - a simple tunnel written in golang
* [lantern](https://github.com/getlantern/lantern) ⭐ 15,961 | 🐛 39 | 🌐 Dart | 📅 2026-09-11 - Lantern is a free desktop application that delivers fast, reliable and secure access to the open Internet for users in censored regions
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 9,444 | 🐛 6 | 🌐 C++ | 📅 2026-09-12 - NaïveProxy uses Chrome's network stack to camouflage traffic with stronger censorship resistence and less detectablility than custom-made network stacks (Shadowsocks and variants, V2Ray suite, handmade Golang stacks).
* [iodine](https://github.com/yarrick/iodine) ⭐ 7,971 | 🐛 28 | 🌐 C | 📅 2025-09-04 - This is a piece of software that lets you tunnel IPv4 data through a DNS server. This can be usable in different situations where internet access is firewalled, but DNS queries are allowed.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 6,917 | 🐛 339 | 🌐 C | 📅 2026-08-04 - Proxy server which helps telegram users who are inside censored areas still be able to connect to telegram
...
* [amneziawg-installer](https://github.com/bivlked/amneziawg-installer) ⭐ 1,249 | 🐛 9 | 🌐 Shell | 📅 2026-09-12 - Automated one-command setup of AmneziaWG 2.0 VPN on Ubuntu & Debian — an obfuscated WireGuard fork with DPI bypass, client management, and server hardening.
...
* [FTE](https://github.com/kpdyer/fteproxy) ⭐ 155 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - fteproxy provides transport-layer protection to resist keyword filtering, censorship and discriminatory routing policies
...
* [Hedioum Pool Tunnel](https://github.com/hedioum/Hedioum-Pool-Tunnel) ⭐ 133 | 🐛 2 | 🌐 Go | 📅 2026-08-19 - A high-performance anti-DPI tunnel in Go that disguises VLESS/Trojan traffic as SSH, TLS/HTTPS, SMTP/IMAP or a DirectAdmin panel, with dynamic connection pools and real Let's Encrypt certificates.
...
* [go-packetflagon](https://github.com/BrassHornCommunications/go-packetflagon/) ⭐ 14 | 🐛 0 | 🌐 CSS | 📅 2016-04-20 - A local HTTP application that serves customised Proxy Auto Configuration files for your browser to help bypass Internet censorship.
* [Stunning](https://github.com/hbahadorzadeh/stunning) ⭐ 5 | 🐛 11 | 🌐 Go | 📅 2026-06-15 - Multi-protocol tunneling engine with composable anti-DPI plugin chains (TLS/HTTP mimicry, padding, traffic morphing) and access-control gates, written in Go.
...
* [ipfs](https://github.com/ipfs/ipfs) ⭐ 23,058 | 🐛 8 | 📅 2025-05-01 - IPFS is a global, versioned, peer-to-peer filesystem ([awesome list](https://github.com/ipfs/awesome-ipfs) ⭐ 4,609 | 🐛 19 | 🌐 JavaScript | 📅 2025-11-13)
* [ZeroNet](https://github.com/HelloZeroNet/ZeroNet) ⭐ 18,767 | 🐛 781 | 🌐 JavaScript | 📅 2024-01-31 - Decentralized websites using Bitcoin crypto and the BitTorrent network
...
* [GoodbyeDPI](https://github.com/ValdikSS/GoodbyeDPI) ⭐ 28,638 | 🐛 153 | 🌐 C | 📅 2026-01-19 - Passive Deep Packet Inspection blocker and Active DPI circumvention utility (for Windows)
* <https://github.com/gfwlist/gfwlist> ⭐ 25,598 | 🐛 1 | 📅 2026-09-11 - Great Firewall of China ban list
...
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,311 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 A curated list of links and tips, to protect privacy and improve security
* [awesome-vpn](https://github.com/hugetiny/awesome-vpn) ⭐ 6,393 | 🐛 0 | 🌐 Python | 📅 2026-09-13 A curated list of awesome free VPNs and proxies.
