...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,569 | 🐛 107 | 📅 2026-09-02 list.
...
* [i2p](https://github.com/i2p/i2p.i2p) ⭐ 2,710 | 🐛 19 | 🌐 Java | 📅 2026-09-26 - I2P is an anonymizing network, offering a simple layer that identity-sensitive applications can use to securely communicate. All data is wrapped with several layers of encryption, and the network is both distributed and dynamic, with no trusted parties.
* [vuvuzela](https://github.com/vuvuzela/vuvuzela) ⭐ 2,487 | 🐛 21 | 🌐 Go | 📅 2019-09-12 - Vuvuzela is a messaging system that protects the privacy of message contents and message metadata. Users communicating through Vuvuzela do not reveal who they are talking to, even in the presence of powerful nation-state adversaries.
...
* [v2ray](https://github.com/v2ray/v2ray-core) ⭐ 46,928 | 🐛 16 | 🌐 Go | 📅 2026-08-31 - A platform for building proxies to bypass network restrictions
* [algo](https://github.com/trailofbits/algo) ⭐ 30,394 | 🐛 77 | 🌐 Python | 📅 2026-09-23 - Set up a personal VPN in the cloud
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,768 | 🐛 99 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW
* [gost](https://github.com/ginuerzh/gost) ⭐ 18,237 | 🐛 291 | 🌐 Go | 📅 2026-08-30 - GO Simple Tunnel - a simple tunnel written in golang
* [lantern](https://github.com/getlantern/lantern) ⭐ 16,043 | 🐛 37 | 🌐 Dart | 📅 2026-09-25 - Lantern is a free desktop application that delivers fast, reliable and secure access to the open Internet for users in censored regions
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 9,463 | 🐛 4 | 🌐 C++ | 📅 2026-09-25 - NaïveProxy uses Chrome's network stack to camouflage traffic with stronger censorship resistence and less detectablility than custom-made network stacks (Shadowsocks and variants, V2Ray suite, handmade Golang stacks).
* [iodine](https://github.com/yarrick/iodine) ⭐ 7,984 | 🐛 22 | 🌐 C | 📅 2026-09-20 - This is a piece of software that lets you tunnel IPv4 data through a DNS server. This can be usable in different situations where internet access is firewalled, but DNS queries are allowed.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 6,924 | 🐛 340 | 🌐 C | 📅 2026-08-04 - Proxy server which helps telegram users who are inside censored areas still be able to connect to telegram
...
* [amneziawg-installer](https://github.com/bivlked/amneziawg-installer) ⭐ 1,311 | 🐛 12 | 🌐 Shell | 📅 2026-09-26 - Automated one-command setup of AmneziaWG 2.0 VPN on Ubuntu & Debian — an obfuscated WireGuard fork with DPI bypass, client management, and server hardening.
...
* [Hedioum Pool Tunnel](https://github.com/hedioum/Hedioum-Pool-Tunnel) ⭐ 136 | 🐛 3 | 🌐 Go | 📅 2026-08-19 - A high-performance anti-DPI tunnel in Go that disguises VLESS/Trojan traffic as SSH, TLS/HTTPS, SMTP/IMAP or a DirectAdmin panel, with dynamic connection pools and real Let's Encrypt certificates.
...
* [ipfs](https://github.com/ipfs/ipfs) ⭐ 23,064 | 🐛 8 | 📅 2025-05-01 - IPFS is a global, versioned, peer-to-peer filesystem ([awesome list](https://github.com/ipfs/awesome-ipfs) ⭐ 4,611 | 🐛 22 | 🌐 JavaScript | 📅 2025-11-13)
...
* [dat](https://github.com/datproject/dat) ⭐ 8,223 | 🐛 106 | 🌐 JavaScript | 📅 2023-05-07 - a decentralized tool for distributing data ([awesome list](https://github.com/clkao/awesome-dat) ⭐ 96 | 🐛 6 | 📅 2017-08-11)
...
* [GoodbyeDPI](https://github.com/ValdikSS/GoodbyeDPI) ⭐ 28,674 | 🐛 153 | 🌐 C | 📅 2026-01-19 - Passive Deep Packet Inspection blocker and Active DPI circumvention utility (for Windows)
* <https://github.com/gfwlist/gfwlist> ⭐ 25,628 | 🐛 2 | 📅 2026-09-26 - Great Firewall of China ban list
...
* [ooni-probe](https://github.com/ooni/probe) ⭐ 921 | 🐛 363 | 📅 2026-09-10 - OONI Probe network measurement tool for detecting internet censorship <https://ooni.io>
...
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,388 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 A curated list of links and tips, to protect privacy and improve security
* [awesome-vpn](https://github.com/hugetiny/awesome-vpn) ⭐ 6,476 | 🐛 1 | 🌐 Python | 📅 2026-09-26 A curated list of awesome free VPNs and proxies.
