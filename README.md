...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,813 | 🐛 100 | 📅 2026-06-30 list.
...
* [i2p](https://github.com/i2p/i2p.i2p) ⭐ 2,674 | 🐛 17 | 🌐 Java | 📅 2026-08-15 - I2P is an anonymizing network, offering a simple layer that identity-sensitive applications can use to securely communicate. All data is wrapped with several layers of encryption, and the network is both distributed and dynamic, with no trusted parties.
...
* [v2ray](https://github.com/v2ray/v2ray-core) ⭐ 46,943 | 🐛 16 | 🌐 Go | 📅 2026-07-13 - A platform for building proxies to bypass network restrictions
* [algo](https://github.com/trailofbits/algo) ⭐ 30,360 | 🐛 77 | 🌐 Python | 📅 2026-08-12 - Set up a personal VPN in the cloud
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,748 | 🐛 98 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW
* [gost](https://github.com/ginuerzh/gost) ⭐ 18,168 | 🐛 291 | 🌐 Go | 📅 2024-12-31 - GO Simple Tunnel - a simple tunnel written in golang
* [lantern](https://github.com/getlantern/lantern) ⭐ 15,875 | 🐛 42 | 🌐 Dart | 📅 2026-08-14 - Lantern is a free desktop application that delivers fast, reliable and secure access to the open Internet for users in censored regions
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 9,378 | 🐛 9 | 🌐 C++ | 📅 2026-07-03 - NaïveProxy uses Chrome's network stack to camouflage traffic with stronger censorship resistence and less detectablility than custom-made network stacks (Shadowsocks and variants, V2Ray suite, handmade Golang stacks).
...
* [ipfs](https://github.com/ipfs/ipfs) ⭐ 23,052 | 🐛 8 | 📅 2025-05-01 - IPFS is a global, versioned, peer-to-peer filesystem ([awesome list](https://github.com/ipfs/awesome-ipfs) ⭐ 4,597 | 🐛 19 | 🌐 JavaScript | 📅 2025-11-13)
* [ZeroNet](https://github.com/HelloZeroNet/ZeroNet) ⭐ 18,765 | 🐛 781 | 🌐 JavaScript | 📅 2024-01-31 - Decentralized websites using Bitcoin crypto and the BitTorrent network
...
* [twister](https://github.com/miguelfreitas/twister-core) ⭐ 1,406 | 🐛 173 | 🌐 C++ | 📅 2024-01-18 - twister is an experimental peer-to-peer microblogging software.
...
* [GoodbyeDPI](https://github.com/ValdikSS/GoodbyeDPI) ⭐ 28,570 | 🐛 147 | 🌐 C | 📅 2026-01-19 - Passive Deep Packet Inspection blocker and Active DPI circumvention utility (for Windows)
* <https://github.com/gfwlist/gfwlist> ⭐ 25,506 | 🐛 2 | 📅 2026-08-10 - Great Firewall of China ban list
...
* [ooni-probe](https://github.com/ooni/probe) ⭐ 912 | 🐛 369 | 📅 2025-01-31 - OONI Probe network measurement tool for detecting internet censorship <https://ooni.io>
...
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,082 | 🐛 54 | 🌐 TypeScript | 📅 2026-02-28 A curated list of links and tips, to protect privacy and improve security
* [awesome-vpn](https://github.com/hugetiny/awesome-vpn) ⭐ 6,077 | 🐛 8 | 🌐 Python | 📅 2026-08-15 A curated list of awesome free VPNs and proxies.
