...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,793 | 🐛 105 | 📅 2026-08-21 list.
...
* [i2p](https://github.com/i2p/i2p.i2p) ⭐ 2,690 | 🐛 16 | 🌐 Java | 📅 2026-09-01 - I2P is an anonymizing network, offering a simple layer that identity-sensitive applications can use to securely communicate. All data is wrapped with several layers of encryption, and the network is both distributed and dynamic, with no trusted parties.
...
* [algo](https://github.com/trailofbits/algo) ⭐ 30,363 | 🐛 75 | 🌐 Python | 📅 2026-08-26 - Set up a personal VPN in the cloud
...
* [gost](https://github.com/ginuerzh/gost) ⭐ 18,197 | 🐛 291 | 🌐 Go | 📅 2026-08-30 - GO Simple Tunnel - a simple tunnel written in golang
* [lantern](https://github.com/getlantern/lantern) ⭐ 15,927 | 🐛 41 | 🌐 Dart | 📅 2026-08-31 - Lantern is a free desktop application that delivers fast, reliable and secure access to the open Internet for users in censored regions
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 9,414 | 🐛 10 | 🌐 C++ | 📅 2026-07-03 - NaïveProxy uses Chrome's network stack to camouflage traffic with stronger censorship resistence and less detectablility than custom-made network stacks (Shadowsocks and variants, V2Ray suite, handmade Golang stacks).
* [iodine](https://github.com/yarrick/iodine) ⭐ 7,961 | 🐛 28 | 🌐 C | 📅 2025-09-04 - This is a piece of software that lets you tunnel IPv4 data through a DNS server. This can be usable in different situations where internet access is firewalled, but DNS queries are allowed.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 6,908 | 🐛 339 | 🌐 C | 📅 2026-08-04 - Proxy server which helps telegram users who are inside censored areas still be able to connect to telegram
...
* [FTE](https://github.com/kpdyer/fteproxy) ⭐ 155 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - fteproxy provides transport-layer protection to resist keyword filtering, censorship and discriminatory routing policies
...
* [marionette](https://github.com/kpdyer/marionette/) ⭐ 112 | 🐛 3 | 🌐 Python | 📅 2026-08-26 - Marionette is a programmable client-server proxy that enables the user to control network traffic features with a lightweight domain-specific language.
...
* [ipfs](https://github.com/ipfs/ipfs) ⭐ 23,060 | 🐛 8 | 📅 2025-05-01 - IPFS is a global, versioned, peer-to-peer filesystem ([awesome list](https://github.com/ipfs/awesome-ipfs) ⭐ 4,611 | 🐛 18 | 🌐 JavaScript | 📅 2025-11-13)
* [ZeroNet](https://github.com/HelloZeroNet/ZeroNet) ⭐ 18,776 | 🐛 781 | 🌐 JavaScript | 📅 2024-01-31 - Decentralized websites using Bitcoin crypto and the BitTorrent network
* [dat](https://github.com/datproject/dat) ⭐ 8,229 | 🐛 106 | 🌐 JavaScript | 📅 2023-05-07 - a decentralized tool for distributing data ([awesome list](https://github.com/clkao/awesome-dat) ⭐ 96 | 🐛 6 | 📅 2017-08-11)
...
* [GoodbyeDPI](https://github.com/ValdikSS/GoodbyeDPI) ⭐ 28,605 | 🐛 153 | 🌐 C | 📅 2026-01-19 - Passive Deep Packet Inspection blocker and Active DPI circumvention utility (for Windows)
* <https://github.com/gfwlist/gfwlist> ⭐ 25,572 | 🐛 1 | 📅 2026-08-30 - Great Firewall of China ban list
...
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,225 | 🐛 56 | 🌐 TypeScript | 📅 2026-02-28 A curated list of links and tips, to protect privacy and improve security
* [awesome-vpn](https://github.com/hugetiny/awesome-vpn) ⭐ 6,244 | 🐛 0 | 🌐 Python | 📅 2026-09-01 A curated list of awesome free VPNs and proxies.
