...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,839 | 🐛 106 | 📅 2026-09-02 list.
...
* [v2ray](https://github.com/v2ray/v2ray-core) ⭐ 46,937 | 🐛 16 | 🌐 Go | 📅 2026-08-31 - A platform for building proxies to bypass network restrictions
* [algo](https://github.com/trailofbits/algo) ⭐ 30,377 | 🐛 77 | 🌐 Python | 📅 2026-09-09 - Set up a personal VPN in the cloud
...
* [gost](https://github.com/ginuerzh/gost) ⭐ 18,222 | 🐛 291 | 🌐 Go | 📅 2026-08-30 - GO Simple Tunnel - a simple tunnel written in golang
* [lantern](https://github.com/getlantern/lantern) ⭐ 15,965 | 🐛 40 | 🌐 Dart | 📅 2026-09-11 - Lantern is a free desktop application that delivers fast, reliable and secure access to the open Internet for users in censored regions
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 9,446 | 🐛 7 | 🌐 C++ | 📅 2026-09-13 - NaïveProxy uses Chrome's network stack to camouflage traffic with stronger censorship resistence and less detectablility than custom-made network stacks (Shadowsocks and variants, V2Ray suite, handmade Golang stacks).
* [iodine](https://github.com/yarrick/iodine) ⭐ 7,972 | 🐛 27 | 🌐 C | 📅 2026-09-13 - This is a piece of software that lets you tunnel IPv4 data through a DNS server. This can be usable in different situations where internet access is firewalled, but DNS queries are allowed.
...
* [amneziawg-installer](https://github.com/bivlked/amneziawg-installer) ⭐ 1,257 | 🐛 8 | 🌐 Shell | 📅 2026-09-13 - Automated one-command setup of AmneziaWG 2.0 VPN on Ubuntu & Debian — an obfuscated WireGuard fork with DPI bypass, client management, and server hardening.
...
* [Hedioum Pool Tunnel](https://github.com/hedioum/Hedioum-Pool-Tunnel) ⭐ 134 | 🐛 2 | 🌐 Go | 📅 2026-08-19 - A high-performance anti-DPI tunnel in Go that disguises VLESS/Trojan traffic as SSH, TLS/HTTPS, SMTP/IMAP or a DirectAdmin panel, with dynamic connection pools and real Let's Encrypt certificates.
...
* [GoodbyeDPI](https://github.com/ValdikSS/GoodbyeDPI) ⭐ 28,635 | 🐛 153 | 🌐 C | 📅 2026-01-19 - Passive Deep Packet Inspection blocker and Active DPI circumvention utility (for Windows)
* <https://github.com/gfwlist/gfwlist> ⭐ 25,600 | 🐛 1 | 📅 2026-09-11 - Great Firewall of China ban list
...
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,317 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 A curated list of links and tips, to protect privacy and improve security
* [awesome-vpn](https://github.com/hugetiny/awesome-vpn) ⭐ 6,401 | 🐛 0 | 🌐 Python | 📅 2026-09-14 A curated list of awesome free VPNs and proxies.
