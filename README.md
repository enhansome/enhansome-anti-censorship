...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,293 | 🐛 105 | 📅 2026-08-18 list.
...
* [i2p](https://github.com/i2p/i2p.i2p) ⭐ 2,684 | 🐛 17 | 🌐 Java | 📅 2026-08-21 - I2P is an anonymizing network, offering a simple layer that identity-sensitive applications can use to securely communicate. All data is wrapped with several layers of encryption, and the network is both distributed and dynamic, with no trusted parties.
...
* [algo](https://github.com/trailofbits/algo) ⭐ 30,357 | 🐛 78 | 🌐 Python | 📅 2026-08-19 - Set up a personal VPN in the cloud
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,745 | 🐛 98 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW
* [gost](https://github.com/ginuerzh/gost) ⭐ 18,183 | 🐛 291 | 🌐 Go | 📅 2024-12-31 - GO Simple Tunnel - a simple tunnel written in golang
* [lantern](https://github.com/getlantern/lantern) ⭐ 15,890 | 🐛 36 | 🌐 Dart | 📅 2026-08-20 - Lantern is a free desktop application that delivers fast, reliable and secure access to the open Internet for users in censored regions
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 9,397 | 🐛 9 | 🌐 C++ | 📅 2026-07-03 - NaïveProxy uses Chrome's network stack to camouflage traffic with stronger censorship resistence and less detectablility than custom-made network stacks (Shadowsocks and variants, V2Ray suite, handmade Golang stacks).
...
* [ipfs](https://github.com/ipfs/ipfs) ⭐ 23,053 | 🐛 8 | 📅 2025-05-01 - IPFS is a global, versioned, peer-to-peer filesystem ([awesome list](https://github.com/ipfs/awesome-ipfs) ⭐ 4,602 | 🐛 19 | 🌐 JavaScript | 📅 2025-11-13)
...
* [GoodbyeDPI](https://github.com/ValdikSS/GoodbyeDPI) ⭐ 28,580 | 🐛 147 | 🌐 C | 📅 2026-01-19 - Passive Deep Packet Inspection blocker and Active DPI circumvention utility (for Windows)
* <https://github.com/gfwlist/gfwlist> ⭐ 25,539 | 🐛 4 | 📅 2026-08-19 - Great Firewall of China ban list
...
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,141 | 🐛 56 | 🌐 TypeScript | 📅 2026-02-28 A curated list of links and tips, to protect privacy and improve security
* [awesome-vpn](https://github.com/hugetiny/awesome-vpn) ⭐ 6,131 | 🐛 7 | 🌐 Python | 📅 2026-08-21 A curated list of awesome free VPNs and proxies.
